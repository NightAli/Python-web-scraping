...
# Auto-annotated: from wordcloud import WordCloud, ImageColorGenerator, STOPWORDS
from wordcloud import WordCloud, ImageColorGenerator, STOPWORDS
# Auto-annotated: imports jieba
import jieba
# Auto-annotated: imports jieba.analyse
...
#開始段詞與排序
freq = {}
# Auto-annotated: for ele in dictionary
for ele in dictionary:
# Auto-annotated: if ele in tags
    if ele in tags:
